...
HD_PWD='C:/Users/Vincent G/Desktop/gsplat/gsplat.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_gsplat.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_gsplat.tcl
