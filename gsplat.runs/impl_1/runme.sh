...
HD_PWD='C:/Users/Vincent G/Desktop/gsplat/gsplat.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_gsplat.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_gsplat.tcl -notrace
